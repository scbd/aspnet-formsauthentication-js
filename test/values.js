...
var DATE1 = new Date('2015-09-29T19:31:18.959Z');
var DATE2 = new Date('2015-09-29T19:32:31.232Z');
...
describe('FormsAuthentication', function() {
    ...
    describe('decrypt()', function () {
        ...
        it('should match reference value', function () {
            ...
            assert.equal(ticket.issueDate.toISOString(),  DATE1.toISOString());
            assert.equal(ticket.expiration.toISOString(), DATE2.toISOString());
